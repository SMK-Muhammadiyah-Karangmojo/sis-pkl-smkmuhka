                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div>
                                    <img src="<?= showImage($data_presence->image_in); ?>" alt="<?= $data_presence->image_in; ?>" width="280px" height="300px">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="col-sm-12">
                    ...
                    <div class="col-sm-6">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div>
                                    <img src="<?= showImage($data_presence->image_out); ?>"
                                         alt="<?= $data_presence->image_out;?>" width="280px" height="300px">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="col-sm-12">
